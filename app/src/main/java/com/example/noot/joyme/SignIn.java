...
public class SignIn extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                ...
                                DatabaseReference newUserRef = usersRef.child(mAuth.getCurrentUser().getUid());
                                User user = new User(mAuth.getCurrentUser().getEmail());
                                Data.getInstance().setUpUser(user);
                                newUserRef.updateChildren(user.getUserUpdate());
    ...
    ChildEventListener childEventListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey) {
            Data.getInstance().updateUser(dataSnapshot);
        }
